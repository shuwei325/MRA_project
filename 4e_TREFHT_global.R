...
load("D:/UCR/CIMPA/Gauss server/Emuladores/datos/TREFHT_Global.Rdata")
y1 <- TREFHT_Global %>% filter(lat>=30 & lat<=31 & lon>=240 & lon <=241)
y2 <- TREFHT_Global %>% filter(lat>=30 & lat<=31 & lon>=260 & lon <=261)
y3 <- TREFHT_Global %>% filter(lat>=30 & lat<=31 & lon>=291 & lon <=292)
y4 <- TREFHT_Global %>% filter(lat>=41 & lat<=42 & lon>=240 & lon <=241)
y5 <- TREFHT_Global %>% filter(lat>=41 & lat<=42 & lon>=260 & lon <=261)
y6 <- TREFHT_Global %>% filter(lat>=41 & lat<=42 & lon>=291 & lon <=292)
y7 <- TREFHT_Global %>% filter(lat>=51 & lat<=52 & lon>=240 & lon <=241)
y8 <- TREFHT_Global %>% filter(lat>=51 & lat<=52 & lon>=260 & lon <=261)
y9 <- TREFHT_Global %>% filter(lat>=51 & lat<=52 & lon>=291 & lon <=292)

datos <- data.frame(y1[,1:2],y1$TREFHT,y2$TREFHT,y3$TREFHT,y4$TREFHT,y5$TREFHT,y6$TREFHT,y7$TREFHT,y8$TREFHT,y9$TREFHT)
